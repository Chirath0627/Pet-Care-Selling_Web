...
<body>
  ...
  <div class="payment-container">
    ...
    <form class="payment-form" action="seller-payment-success.php" method="POST">
      ...
      <a href="seller-index.php" class="back-btn">Back to Home</a>
    </form>
  </div>
