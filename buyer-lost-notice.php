...
<body>
  ...
  <div class="notice-container">
   ...
   <form class="notice-form" action="buyer-save-notice.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="btn-group">
        ...
        <button type="button" class="cancel-btn" onclick="window.location.href='buyer-display-notice.php'">Cancel</button>
      </div>
    </form>
  </div>
